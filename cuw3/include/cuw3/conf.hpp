...
namespace cuw3 {
    ...
    inline constexpr gsize conf_fast_arena_min_alignment_log2 = CUW3_MIN_ALIGNMENT_LOG2;
    inline constexpr gsize conf_fast_arena_max_alignment_log2 = CUW3_MAX_ALIGNMENT_LOG2;

    static_assert(conf_fast_arena_min_alignment_log2 <= conf_fast_arena_max_alignment_log2, "fast arena min alignment pow2 is greater than fast arena max alignment pow2");

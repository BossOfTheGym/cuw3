...
namespace cuw3 {
    ...
    inline constexpr gsize conf_thread_local_allocator_max_regions = conf_max_region_sizes;
    inline constexpr gsize conf_thread_local_allocator_num_fast_arenas = conf_fast_arena_max_alignment_pow2 - conf_fast_arena_min_alignment_pow2 + 1;
    inline constexpr gsize conf_thread_local_allocator_num_chunk_pools = conf_max_chunk_pow2 - conf_min_chunk_pow2 + 1;

    inline constexpr gsize conf_thread_local_allocator_max_pow2_chunk_pools = 16;
    inline constexpr gsize conf_thread_local_allocator_max_fast_arenas = 8;

    static_assert(conf_thread_local_allocator_num_chunk_pools <= conf_thread_local_allocator_max_pow2_chunk_pools, "num of pools exceeeds capacity for thread local allocator");
    static_assert(conf_thread_local_allocator_num_fast_arenas <= conf_thread_local_allocator_max_fast_arenas, "num of fast arenas exceeds capacity for thread local allocator");

    inline constexpr uint64 conf_fast_arena_max_split = CUW3_FAST_ARENA_MAX_SPLIT;

    static_assert(conf_fast_arena_max_split <= 64 && conf_fast_arena_max_split >= 1, "invalid value for fast arena split free range split value");
}